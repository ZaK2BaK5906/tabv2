...
const ShellLayout = ({ children }: { children: React.ReactNode }) => (
  <div className="flex h-screen w-screen bg-base-950 text-white">
    <aside className="flex w-24 flex-col items-center gap-6 border-r border-white/5 bg-base-900 py-8">
    ...
    <main className="flex flex-1 flex-col overflow-hidden">
      <Topbar />
      <div className="flex-1 overflow-y-auto px-10 pb-10 pt-6 scrollbar-thin">
        {children}
      </div>
    </main>
  </div>
